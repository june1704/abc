...
public class I_Practice {
    public static void main(String[] args) {
        ...
        // Employee(department=IT, name=김준일, salary=6500.0)
        ...
        System.out.print("이름에 '조'가 포함된 직원: ");
        employeesWithJo.forEach(System.out::println);
        // 이름에 '조'가 포함된 직원: Employee(department=HR, name=조승범, salary=7000.0)
        ...
        // HR=[Employee(department=HR, name=조승범, salary=7000.0), Employee(department=HR, name=윤대휘, salary=6300.0)],
