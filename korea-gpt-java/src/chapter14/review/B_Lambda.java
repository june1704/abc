...
public class B_Lambda {
    public static void main(String[] args) {
        ...
        // === 람다식 사용 예시 ===
        // @FunctionalInterface(하나의 추상 메서드만 가지는 인터페이스)와 함께 사용
        ...
        Function<String, Integer> fx = s -> s.length(); // 입력값을 다른 타입으로 변환
        Function<String, String> fx2 = s -> s.toUpperCase(); // 같은 타입 변환
        ...
        System.out.println(event.test(10)); // true
        System.out.println(event.test(11)); // false
