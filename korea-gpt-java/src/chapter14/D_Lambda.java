...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println(calculator1.add(3, 5));

        // 람다식 방식
        // 1) 기본 방식
        Calculator calculator2 = (a, b) -> a + b;
        System.out.println(calculator2.add(3, 5));

        // 2) 매개변수가 없는 방식
        NoParams noParams = () -> System.out.println("안녕하세요");

        // 3) 매개변수가 한 개인 방식
        OneParams oneParams = message -> System.out.println("출력메시지: " + message);
        oneParams.print("안녕");
