...
public class UserService {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(user1.getSignUpDate()); // Thu Dec 12 12:06:26 KST 2024

        List<User> userList = null;
        List<UserSignUpRequestDto> dtos = new ArrayList<>();
        dtos.add(new UserSignUpRequestDto("123", "1234", "1234", "최명준1",
                                        "qwe", "01012345678", "개구리"));
        dtos.add(new UserSignUpRequestDto("123", "1234", "1234", "최명준2",
                                        "qwe", "01012345678", "개구리"));
        dtos.add(new UserSignUpRequestDto("123", "1234", "1234", "최명준3",
                                        "qwe", "01012345678", "개구리"));
