...
// 새 책을 책장의 중간에 추가할 경우 - 책을 모두 한 칸씩 옮겨야 함 (시간 오래걸림)
...
// 특정 날짜의 대출 기록을 찾으려면 처음부터 하나씩 기록을 읽어야 함(시간 오래걸림)
...
public class B_List {
    public static void main(String[] args) {
        ...
        // cf) ArrayList 클래스 - AbstractList 를 상속받음
        ...
        System.out.println("ArrayList 삽입 시간: " + (endTime - startTime) + "ns"); // 359473300ns - 약 3억 나노초
        ...
        System.out.println("linkedList 삽입 시간: " + (endTime - startTime) + "ns"); // 3285500ns - 약 200만 나노초
    }
}
