...
public class StudentManagementApp {
    ...
    public static void main(String[] args) {
        // 학생 추가
        addStudent (1, "최명준", 30, "GPT반", 4.0);
        addStudent (2, "이승아", 28, "IoT반", 2.8);
        addStudent (3, "김영경", 25, "GPT반", 2.0);
        addStudent (4, "원신희", 40, "JAVA반", 4.1);

        printAllStudents();

        findStudentById(3); // ID: 3, name: 김영경, Age: 25, Major: GPT반, GPA: 2.0
