...
public class C_Conversion {
    public static void main(String[] args) {
        ...
        char example = '가';
        System.out.println((int)example); // 44032(char를 int타입으로 강제 형변환)
        System.out.println((int)example + 1); // 44033(char를 int타입으로 강제 형변환 + 1)
        System.out.println((char)((int)example + 1)); // 각(int타입을 다시 char로 강제 형변환 + 1)
        ...
        System.out.println(charType); // (놈 + ㅇ)
