...
public class B_ENUM {
    public static void main(String[] args) {
        ...
        // Fruits orangerFruits = Fruits.valueOf("Orange"); // IllegalArgumentException
        Fruits orangerFruits = Fruits.valueOf("ORANGE");
        System.out.println(orangerFruits.ordinal()); // 2

        // === CoffeeSize 자료형 사용 === //
        CoffeeSize size = CoffeeSize.MEDIUM;
        System.out.println("선택된 사이즈: " + size + ", 용량: " + size.getMl() + "ml");
        // 선택된 사이즈: MEDIUM, 용량: 300ml
    }
}
