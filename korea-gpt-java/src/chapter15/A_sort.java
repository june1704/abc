...
public class A_sort {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(numbers)); // [1, 2, 3, 4, 8]
        ...
        names.sort(Comparator.comparingInt(String::length)); // Comparator비교클래스.comparingInt인트로 변경할래요
        ...
        // : List 인터페이스 메서드
        // - 리스트를 특정 기준에 따라 정렬
        // - 정렬 기준을 결정하는 Comparator(두 객체를 비교하여 정렬 순서를 절정)를 인수로 받음
        ...
        System.out.println(reverseSorted); // [8, 4, 3, 2, 1]
        ...
        fruits.sort(Comparator.comparingInt(String::length)
                // String 클래스 compareTo 메서드-내장 기능
                // : 두 개의 문자열 값을 비교하여 int 값으로 반환해주는 함수
                .thenComparing(String::compareTo));

        System.out.println(fruits); // [kiwi, apple, mango, banana, strawberry] - 애플과 망고는 두 개의 문자열 값을 비교
    }
}
