...
public class Method01 {
    public static void main(String[] args) {
        ...
        System.out.println(calculator.addNumbers(10,20)); // 30

        int result1 = calculator.addNumbers(50, 30);
        int result2 = calculator.addNumbers(12345, 678910);

        System.out.println(result1); // 80
        System.out.println(result2); // 691255
    }
}
