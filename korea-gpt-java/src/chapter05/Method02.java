...
public class Method02 {
    public static void main(String[] args) {
        ...
        // 함수의 파라미터에 데이터 전달
        // : 함수 호출 시 ()영역 내에서 parameter에 전달되는 값은 argument라고 부름

        // 매개변수(Parameter) VS 인자(인수, Argument)
        // 1. 매개변수
        // - 메서드를 정의할 때 괄호 안에 선언되는 변수
        // - 메서드가 호출 될 때 값을 전달받기 위한 입력변수로 사용
        // > 메서드의 선언부에 정의, 호출 시 전달받은 값은 내부적으로 사용

        // 2. 인자(인수)
        // - 메서드를 호출할 때 괄호 안에 전달하는 '값'
        // - 호출된 메서드의 매개변수에 실제 값을 전달
        // > 메서드의 호출부에서 전달, 매개변수에 전달외어 메서드 안에서 사용

//        example.add(1); - 에러
//        example.add(10, 20, 30); - 에러 (인자값은 매개변수의 수와 같아야 한다!)

//        example.add("10", "20"); - 에러 (인자값은 매개변수의 타입과 같거나 자동 형 변환이 가능해야 한다!)
