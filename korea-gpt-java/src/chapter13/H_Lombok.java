...
// - 클래스 내의 데이터 문자열 출력을 담당

// @Override
//public String toString() {
//    return "Titie: " + title + ", Author" + author;
// }
...
public class H_Lombok {
    public static void main(String[] args) {
        ...
        //lombokClass2.setTitle("이도경 안녕");
        lombokClass2.setAuthor("이도경");

        System.out.println(lombokClass1); // LombokClass(title=이도경 안녕, author=이도경)
        System.out.println(lombokClass2); // LombokClass(title=이도경 안녕, author=이도경)
...
//                .author("루피")
//                .build();
//        System.out.println(lombokClass4.getTitle()); // 에러
