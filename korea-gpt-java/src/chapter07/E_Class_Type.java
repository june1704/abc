...
public class E_Class_Type {
    public static void main(String[] args) {
        ...
        ChildObject.displayInfo(); // 자식 클래스 입니다.
//        childObject.childMethod(); - 에러 자식클래스의 고유 메서드는 호출 불가
