...
//        1) Book 클래스
//        속성: title(String), author(String), isAvailable(boolean)대여가능 여부
//        메서드: 생성자(title, author), borrowBook(), returnBook()반납, displayInfo() 출력
class Book {
...
public class D_OOP_Practice {
    public static void main(String[] args) {
        ...
        book1.borrowBook(); // 책 대여가 성공적으로 완료 되었습니다.
        book1.displayInfo(); // 제목: 작별하지 않는다, 저자: 한강, 대여 가능 여부: 대여 중
        ...
        ebook1.displayInfo();
        //제목: 달러구트 꿈 백화점, 저자: 이미예, 대여 가능 여부: 대여 가능
        //파일 크기: 867.0MB

        ebook1.borrowBook(); // 책 대여가 성공적으로 완료 되었습니다.
